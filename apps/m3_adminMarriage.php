    ...
    <div class="content-admin">
      ...
      <div class="content-of-module-admin">
        <div style="padding: 20px 0px 20px 6px">
          ...
          <button class=" btn btn-secondary"><a style="text-decoration:none;" href="m3_adminMarriage.php">
              <h6 style="color:white;">Mohon Pengesahan Nikah </h6>
            </a></button>
          <button><a style="text-decoration:none;" href="m3_adminCard.php">
          ...
          <div style="padding: 10px 0px 20px 700px"><a href="m3_adminMarriageList.php"><button class=" btn btn-success">Carian</button></a></div>
        </div>
