  ...
  <div class="overlay">
    ...
    <div class="content-admin">
      <div class="p-2 mb-2 bg-success text-white">
        <span class="h6 text-uppercase">PENDAFTARAN PERKAHWINAN > Mohon Pengesahan Nikah</span>
      </div>
      <div class="content-of-module-admin">
        <div style="padding: 20px 0px 20px 6px">
          <button class=" btn btn-secondary"><a style="text-decoration:none;" href="../ManageMarriageRegistrationStaffView/m3_adminMarriage.php">
              <h6 style="color:white;">Mohon Pengesahan Nikah </h6>
            </a></button>
          <button><a style="text-decoration:none;" href="../ManageMarriageCardApplicationStaffView/m3_adminCard.php">
              <h6 style="color:black;">Mohon Pengesahan Kad Nikah Dan Sijil</h6>
            </a></button><br><br><br>
          <b>No.K/P Pemohon</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"><br><br>
          ...
          <div style="padding: 10px 0px 20px 700px"><a href="../ManageMarriageRegistrationStaffView/m3_adminMarriageList.php"><button class=" btn btn-success">Carian</button></a></div>
        </div>
      </div>
    </div>
